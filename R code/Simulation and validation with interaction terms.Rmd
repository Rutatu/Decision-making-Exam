...
# Assuming 'samples' is your MCMC output from coda.samples()
...
# Assuming you have a vector 'participant_ids' that corresponds to the participant IDs
plot_data <- data.frame( 
                        ParticipantEffect = estimated_participant_effects)
# Assuming 'msi_scores' is a vector of MSI scores corresponding to each participant
...
# Load the model
model_file = "Models/GROOVE_model_prior_change.txt"
